 ...
 ** REPLACE "<my-github-repo>" by your github repo. Eg. isa-group/governify-project-gauss-reporter
 * 
 */
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        /**
         * Usage:
         *   grunt release:1.0.0" for patch versions
        ...
        release: {
            options: {
                ...
                updateVars: ['pkg'],
                github: {
                    repo: "isa-group/governify-project-gauss-reporter",
