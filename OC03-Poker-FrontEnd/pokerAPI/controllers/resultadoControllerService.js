  ...
  function checkCards(){
        ...
        json.partida.forEach(element => {
            ...
            element.jugadas.forEach(jugadores => {
                ...
                var pair =          false               //Par
                var doublePair =    false               //Doble par
                var trio =          false               //Trio
                var escalera =      false               //Escalera
                var color =         false               //Color
                var full  =         false               //Full
                var poker =         false               //Poker
                ...
                cartas.forEach(cardPicked => {
                    ...
                    var valorSumado = cardValue(cartas[j].valor)
                    valorSumado++
                    if(j<4){
                        ...
                        if(valorSumado == cardValue(cartas[j+1].valor)){
                            auxEscalera++
                        }
                    }
